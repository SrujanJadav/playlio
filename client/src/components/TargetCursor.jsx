...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      if (!activeTarget || !cursorRef.current || !cornersRef.current || !targetCornerPositionsRef.current) {
        return;
      }

      // Recalculate target positions in real time to adapt to moving/translating elements on hover
